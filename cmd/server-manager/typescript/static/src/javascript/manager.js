...
exports.initMultiSelect = exports.EntryPoint = void 0;
...
exports.initMultiSelect = initMultiSelect;
...
class RaceSetup {
    constructor($parent) {
        ...
        if (this.$trackDropdown.length && this.$trackLayoutDropdown.length) {
            ...
            Form_1.Form.initialiseSelect2OnElement(that.$trackDropdown);
            Form_1.Form.initialiseSelect2OnElement(that.$trackLayoutDropdown);
    ...
    loadTrackLayouts() {
        ...
        Form_1.Form.initialiseSelect2OnElement(this.$trackLayoutDropdown);
...
let championships = {
    ...
    initClassSetup: function () {
        ...
        $addClassButton.click(function (e) {
            ...
            new CarSearch_1.CarSearch($cloned);
            let maxClients = $("#MaxClients").val();
